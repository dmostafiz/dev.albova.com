            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-7 col-xl-8">
                        <div class="form-left">
                            <h1 class="title text-center text-lg-left">{{__('Albova the solution! ')}}</h1>
                            <h4 class="description text-center text-lg-left">{!! __( 'Albova takes care of everything! <br/> - With albova the clients come to you. <br/> - You gained more visibility.  <br/> - Your growing turnover.<br/> ** Free only 10% per reservation' ) !!}</h4>
