...
<div class="hh-search-bar-wrapper">
    <div class="hh-search-bar-buttons">
        @php
            $search_text = request()->get('_s', '');
        @endphp
        <div class="form-group search-text">
            <input type="text" class="form-control" placeholder="{{__('Enter your search text')}}" name="_s" value="{{$search_text}}"/>
            <i class="fa fa-search search-kbutton"></i>
        </div>
    ...
    <?php
    $showmap = request()->get('showmap', 'no');
    ?>
        ...
        <div class="render-box">
            ...
            <div class="popup-filter-content">
                ...
                <div class="filter-item">
                    <p class="filter-item-title">{{__('Search by keyword')}}</p>
                    <div class="form-group search-text">
                        <input type="text" class="form-control" placeholder="{{__('Enter your search text')}}" name="_s" value="{{$search_text}}"/>
                        <i class="fa fa-search search-kbutton"></i>
                    </div>
