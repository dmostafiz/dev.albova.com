            ...
            <div class="card-box">
                ...
                <table id="table-my-experience" class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    <tr>
                        ...
                        <th data-priority="-1" class="d-flex align-items-center pl-0">

                            <div class="checkbox checkbox-success hh-check-all" style="margin-top: -9px">
                        ...
                        <th data-priority="3" class="text-center"><span class="exp">{{__('Max. People')}}</span></th>

                        <th data-priority="4"><span class="exp">{{__('Type')}}</span></th>
...
<div class="checkbox checkbox-success" style="margin-top: -9px">
                                            <input type="checkbox" name="post_id" value="{{$item->post_id}}" id="hh-check-all-item-{{$item->post_id}}"
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h5 class="m-0 white-space-normal"><a href="{{ get_experience_permalink($experienceID, $item->post_slug) }}"
