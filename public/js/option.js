...
(function ($) {
    ...
    var HHOptions = {
        ...
        gotoPrevNext: function (el) {
            var base = this;
            $(document).on('click', '.btn-prev-tab-option', function(ev){
                ev.preventDefault();
            ...
            $(document).on('click', '.btn-next-tab-option', function(ev){
                ev.preventDefault();
                let currenTab = $(this).data().tab,
            ...
            $(document).on('click', '.btn-current-tab-option', function(ev){
                ev.preventDefault();
                let currenTab = $(this).data().tab;
