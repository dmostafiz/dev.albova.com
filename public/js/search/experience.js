    ...
    $(document).ready(function () {
        ...
        let Search_Result_Page = {
            ...
            _eventsSearch: function () {
                ...
                base.search_container.on('click', '.search-text .fa', function (ev) {
                    ev.preventDefault();
                    var t = $(this),
                        parent = t.parent(),
                        input = parent.find('input[type="text"]');
                    base.dataFilter['_s'] = input.val();
                    base._searchCallBack(true, true);
                    base.pushStateToFilter('_s', input.val());
                });
                                ...
                                if (Object.keys(res.locations).length > 0) {
                                    ...
                                    if (typeof mapboxgl === 'object' && hh_params.mapbox_token !== '') {
                                        ...
                                        $('.hh-mapbox-search', base.search_container).each(function () {
                                            if (typeof base.mapObject == 'undefined' || firstTime < 2) {
                                                let t = $(this),
                                                    zoom = 13;
